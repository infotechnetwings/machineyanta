...
class MyTheme{
  ...
  static Color accent_color = Color.fromRGBO(0, 191, 255, 1.0);
  static Color soft_accent_color = Color.fromRGBO(84, 214, 255, 1.0);
  static Color splash_screen_color = Color.fromRGBO(0, 191, 255, 1.0); // if not sure , use the same color as accent color
